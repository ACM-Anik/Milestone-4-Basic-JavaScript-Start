...
// target 50 to 100 all odd numbers:-
var number = 51;
while(number <= 100){
    console.log(number);
    number = number + 2;
...
// My own diffrent way & odd numbers from a array:-
// function oddNum(num){
//     let allOdd = [];
...
//     return allOdd;
// }
// const myArray = [30, 50, 40, 70, 93, 55, 60, 76, 35, 85, 83, 80, 90, 100, 95, 103, 65, 120, 125,  150];
// const allOdd = oddNum(myArray);
// console.log(allOdd);
...
function celsiusToFahrenheit(fahrenheit){
    const celsius = fahrenheit * (1 / 33.8);
...
function findoutInterest(number){
    let interest = number / 100;
    return interest;
}
const interest = findoutInterest(10);
